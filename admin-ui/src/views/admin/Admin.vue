<template>
  ...
  <el-dialog v-model="state.showEdit" :title="state.editType" class="dialog" @closed="editClosed">
    <el-form label-width="auto">
      <el-form-item label="名称">
        <el-input v-model="state.data.name" placeholder="请填写管理员名称" />
      </el-form-item>
      ...
      <el-form-item label="密码">
        <el-input v-model="state.data.password" type="password" placeholder="请填写管理员密码" />
      </el-form-item>
    </el-form>
    <template #footer>
  ...
  <el-dialog v-model="state.showSearch" title="检索" class="dialog">
    <el-form label-width="auto">
      <el-form-item label="名称">
        <el-input v-model="state.search.name" placeholder="请填写管理员名称" />
      </el-form-item>
      <el-form-item label="账号">
        <el-input v-model="state.search.account" placeholder="请填写管理员账号" />
      </el-form-item>
    </el-form>
    <template #footer>
      <div class="dialog-footer">
